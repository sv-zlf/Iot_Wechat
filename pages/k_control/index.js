...
const deviceConfig = {
  ...
  deviceName: "k_control",
  deviceSecret: "971a2e058dd4dc7204c967727b143d6e",
  ...
  online:function(){
    ...
    //接收消息监听
      client.on('message', function (subTopic, message) {
         ...
         that.setData({
        //  temperature:message['items']['temperature']['value'],
          humidity:message['items']['humidity']['value']
        })
