  ...
  online:function(){
    ...
    client.on('message', function (subTopic, message) {
       ...
       that.setData({
        ...
        humidity:message['items'][Identifier.valueKey]['value']
      })
